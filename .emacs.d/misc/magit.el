...
(defun magit-list-interesting-refs (&optional dont-list-remotes)
  (let ((refs ()))
...
(defun magit-read-rev (prompt &optional def dont-list-remotes)
  (let* ((prompt (if def
		     (format "%s (default %s): " prompt def)
		   (format "%s: " prompt)))
	 (interesting-refs (magit-list-interesting-refs dont-list-remotes))
